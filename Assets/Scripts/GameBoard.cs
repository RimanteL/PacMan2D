...
public class GameBoard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (GameObject o in objects) 
        {
            ...
            if (o.name != "PacMan" && o.name != "Nodes" && o.name != "NoNodes" && o.name != "Maze" && o.name != "Pellets" && o.name != "Game" && o.tag != "Ghost" && o.tag != "ghostHome" && o.name != "Canvas" && o.tag != "UIElements") 
            {
    ...
    private void StartNextLevel ()
    {
        ...
        StartCoroutine (ProcessStartNextLvel (1));
    }

    IEnumerator ProcessStartNextLvel (float delay)
    {
    ...
    {   
        ...
        if (GameMenu.livesPlayerOne == 0 && GameMenu.livesPlayerTwo == 0)
        {
            ...
            if (isPlayerOneUp)
            {
                ...
                StopCoroutine (StartBlinking (playerTwoUp));
            }
